...
class TasksRepositoryImpl @Inject constructor(
    ...
    override fun getTasksAfterFiveDays(today: Long, afterFiveDays: Long): Flow<List<Tasks>> {
        return tasksDataSource.getTasksInFiveDays(today, afterFiveDays)
            .map {
                it.map { taskEntity ->
                    taskEntity.toDomain()
                }
